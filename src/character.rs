...
use crate::{
    animation::Animation,
    config::{WINDOW_BOTTOM_Y, WINDOW_LEFT_X},
};
...
impl CharacterBundle {
    fn new(atlas_handle: Handle<TextureAtlas>) -> Self {
        Self {
            sprite_bundle: SpriteSheetBundle {
            ...
            collider: Collider::cuboid(SPRITE_TILE_WIDTH / 2.0, SPRITE_TILE_HEIGHT / 2.0),
...
fn setup(
    ...
    let image_handle = server.load("spritesheets/spritesheet_players.png");
    ...
    commands.spawn(CharacterBundle::new(atlas_handle));
}
